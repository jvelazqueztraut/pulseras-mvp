...
Pushes to `main` also build that debug APK on GitHub Actions and publish it
as the latest [GitHub Release](https://github.com/jvelazqueztraut/pulseras-mvp/releases/latest)
(see [ANDROID.md](ANDROID.md#github-actions)).
